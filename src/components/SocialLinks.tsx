...
const socials = [
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/pranaveshn',
    accent: '#0a66c2',
    icon: (
    ...
    <div className="social-dock-container">
      ...
      <div className="social-dock">
        {socials.map((s) => (
          ...
          >
            <div className="social-dock-icon">{s.icon}</div>
            <span className="social-dock-tooltip" style={{ backgroundColor: s.accent }}>
              {s.name}
            </span>
          </motion.a>
        ))}
