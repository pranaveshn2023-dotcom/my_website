...
const projectsData = [
  {
    ...
    name: 'ValarchiX',
    category: 'Personal Finance Learning Platform',
    accent: '#10B981',
  ...
  },
  {
    ...
    tabLabel: 'Marakadhey',
    category: 'Browser Extension & Android App',
    accent: '#A855F7',
  ...
  },
  {
    ...
    tagline: 'A real-time Neo-Brutalist personal finance & portfolio tracking PWA. Features live IST stock & mutual fund P/L valuation, database-backed caching to prevent unwanted API calls, double-entry expense ledger, and automated statement ingestion.',
